...
class InspectionTypeInputSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $arrayData = [
            ...
            [
                'inspection_type_group_id' => 13,
                'name' => 'Luces parqueo y reversa',
            ],
            [
                'inspection_type_group_id' => 13,
                'name' => 'Cinturones de seguridad en buen estado',
            ],
            [
                'inspection_type_group_id' => 13,
                'name' => 'Espejos retrovisor interno',
            ],
            [
                'inspection_type_group_id' => 13,
                'name' => 'Espejos retrovisores laterales',
            ],
            [
                'inspection_type_group_id' => 13,
                'name' => 'Botiquín',
            ...
            [
                'inspection_type_group_id' => 13,
                'name' => 'Extintor de  10 Lbs recargado',
            ],
            [
                'inspection_type_group_id' => 13,
                'name' => 'Sillas en buen estado',
            ...
            [
                'inspection_type_group_id' => 13,
                'name' => 'Llantas sin cortaduras y presion adecuada',
            ],
            [
                'inspection_type_group_id' => 13,
                'name' => 'Barra antivuelco fijada al vehiculo',
            ],
            [
            ...
            [
                'inspection_type_group_id' => 14,
                'name' => 'Ausencia de fugas de fluidos',
            ],
            [
                'inspection_type_group_id' => 14,
            ...
            [
                'inspection_type_group_id' => 14,
                'name' => 'Ausencia de fugas de aire',
            ],
            [
                'inspection_type_group_id' => 14,
            ...
            [
                'inspection_type_group_id' => 15,
                'name' => 'Gato y cruceta disponible',
            ],
            [
                'inspection_type_group_id' => 15,
                'name' => '2 Conos',
            ...
            [
                'inspection_type_group_id' => 15,
                'name' => 'Nivel refrigerante del motor',
            ],
            [
                'inspection_type_group_id' => 15,
                'name' => 'Vidrio panorámico sin fisuras',
            ...
            [
                'inspection_type_group_id' => 15,
                'name' => 'Sistema de monitoreo global GPS',
            ],
        ];
