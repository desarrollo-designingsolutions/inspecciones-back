...
use App\Models\MaintenanceTypeInputResponse;

class MaintenanceInputResponseRepository extends BaseRepository
{
    public function __construct(MaintenanceTypeInputResponse $modelo)
    {
